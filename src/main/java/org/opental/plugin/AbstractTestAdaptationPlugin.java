...
public abstract class AbstractTestAdaptationPlugin implements TestAdaptationPlugin {

	private static final Logger logger = LoggerFactory.getLogger(AbstractTestAdaptationPlugin.class);
	
	protected TestAdaptationType adaptionType;

	protected AbstractTestAdaptationPlugin() {
		throw new UnsupportedOperationException("Use constructor without setting the adaption type is forbidden.");
	}

	protected AbstractTestAdaptationPlugin(TestAdaptationType aType) {
		this.adaptionType = aType;
	}

	public TestAdaptationType getType() {
